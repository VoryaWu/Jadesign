...
import sty from "./PlasmicButton.module.css"; // plasmic-import: E_ek0IN7S8tBa/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: eqVFxNaJdtITtc/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: z72JcGwFk-t_ay/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__t6MXg)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__uo4Xg)}
                role={"img"}
              />
            ),
